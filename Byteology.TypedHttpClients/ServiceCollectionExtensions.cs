...
namespace Byteology.TypedHttpClients
{
    ...
    {
        /// <inheritdoc cref="AddTypedHttpClient{TServiceContract, TClient}(IServiceCollection, Action{HttpClient})"/>
        ...
        {
            return AddTypedHttpClient<TServiceContract, TClient>(services, x => { });
        }
